...
public class PetStoreTestLog {
    ...
    private static final Logger logger = LogManager.getLogger(PetStoreTestLog.class);
    ...
    public void addNewPetToStore() throws IOException {
        ...
        logger.info("Add New Pet to Store - Status Code: " + statusCode);
        logger.info("Add New Pet to Store - Response Body: " + responseBody);
    ...
    public void uploadImageWithPetId() {
        ...
        logger.info("Upload Image with Pet ID - Status Code: " + statusCode);
        logger.info("Upload Image with Pet ID - Response Body: " + responseBody);
    ...
    public void getPetById() {
        ...
        logger.info("Get Pet by ID - Status Code: " + statusCode);
        logger.info("Get Pet by ID - Response Body: " + responseBody);
    ...
    public void updatePetInStoreWithFormData() throws IOException {
        ...
        String filePath = "src/test/java/petstoreswagger/finalproj/updatepayload.json";
        ...
        logger.info("Update Pet in Store with Form Data - Status Code: " + statusCode);
        logger.info("Update Pet in Store with Form Data - Response Body: " + responseBody);
   ...
   /* @Test
    public void deletePetById() {
        ...
        logger.info("Delete Pet by ID - Status Code: " + statusCode);
        logger.info("Delete Pet by ID - Response Body: " + responseBody);
